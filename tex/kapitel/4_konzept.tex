...
\section{Prozess}
    Im Folgenden wird der interne Ablauf des zu entwickelten Systems (auch Proxy genannt), bestehend aus dem internen Broker, \emph{ClientIn} und \emph{ClientOut}, beschrieben.
