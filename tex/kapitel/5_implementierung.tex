...
\section{Umgebung und Konfiguration} %Projektierung TODO stimmt das?
    %IDE
    Als Entwicklungsumgebung für das Backend wurde \ac{VS} 2016 %\cite{https://visualstudio.microsoft.com/de/vs/}
    von Microsoft verwendet. Dadurch sind auch die Projektdateien, in dem Repository \glqq MQTT-Proxy\grqq{} %\cite{https://github.com/Patrick-DE/MQTT-Proxy}
    ...
    %Warum VC 
    Des Weiteren ist wurde durch die Verwendung von Vue.js %\cite{https://vuejs.org}
    auf Basis von Node.js %\cite{https://nodejs.org/de/}
    entschieden.

    Nuget %\cite{https://www.nuget.org}
